...
<html>
	...
	<!-- container -->
		...
		<div class="top-header">
			<div class="container">
				<div class="top-header-left">
					<ul>
						<li  class="active">{{HTML::link('/myaccountBuyer','My Account', array('style' => 'color:white, hover: pink'))}}</li>
		...
		<div class="main-menu">
			...
			<div class="head-nav">
				...
				<ul>
					...
					<li>{{HTML::link('/productsBuyer','Products', array('style' => 'color:white, hover: pink'))}}</li>
					<li>{{HTML::link('/seller','Sellers', array('style' => 'color:white, hover: pink'))}}</li>
					<li>{{HTML::link('/toppers','Create Cake', array('style' => 'color:white, hover: pink'))}}</li>					<div class="clearfix"> </div>
				</ul>
			</div>	
				<!-- script-for-nav -->
					<script>
		...
		<div class="biseller-info">
          		<div class="container">
						<h2>Cakes</h2>
							<h3 class="new-models">Ordered Cake</h3>
							<ul id="slider">
									<?php
										...
										echo "</br>";
											...
											echo '<div class="add2cart">';
						    					...
						    					echo '<span>';
						    					echo HTML::link('/deleteCake','DELETE');
						    					echo '</span>';
											echo '</div>';
										echo '</div>';
					 					echo '</li>';				
