...
<html>
	...
	<!-- container -->
		...
		<div class="top-header">
			<div class="container">
				<div class="top-header-left">
					<ul>
						<li  class="active">{{HTML::link('/myaccountSeller','My Account', array('style' => 'color:white, hover: pink'))}}</li>
		...
		<div class="main-menu">
			...
			<div class="head-nav">
				...
				<ul>
					...
					<li>{{HTML::link('/addCake','Add a Cake', array('style' => 'color:white, hover: pink'))}}</li>					<div class="clearfix"> </div>
				</ul>
			</div>	
				<!-- script-for-nav -->
					<script>
		...
		<div class="biseller-info">
          		<div class="container">
						<h2>Cakes</h2>
							<h3 class="new-models">Created Cake</h3>
							<ul id="slider">
									<?php
										...
										echo "</br>";
											...
											echo '<div class="add2cart">';
						   						echo '<span>';
						    					echo HTML::link('/updateCake','EDIT');
						    					echo '</span>';
		...
		<div class="best-seller">
				<div class="container">
						<h3 class="new-models">ORDERED CAKES</h3>
						<ul id="slider2">
						</ul>
					</div>
				</div>
